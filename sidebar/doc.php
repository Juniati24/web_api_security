...
<html lang="en">
  <head>
  	<title>Documention LaslesAPI</title>
    <meta charset="utf-8">
...
<!-----navbar end------------------>
    ...
    <h2 class="mb-4">Welcome, developers!</h2>
    <p>LaslesAPI provides a RESTful API (Application Programming Interface) that you can use to create various applications that require student data. Student data is retrieved directly from the LaslesAPI website to maintain data accuracy. However, if you find any invalid data, please report it to our team.
        <br>LaslesAPI is easy to integrate because it uses a REST architecture with JSON response format supported by almost all programming languages. Imagine being able to create an automatic student data retrieval feature on your educational website or creating mobile applications for Android, iOS, and more. 
        Have you got any ideas for applications using LaslesAPI? Feel free to register for an account to get your FREE API Key!</p>
     <h4 class="mb-2">Summary API</h4>
    <p>The 'mahasiswa' method is used to retrieve a list of students.</p>
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                <td>GET</td>
                <td>http://localhost/api/api_key/new_api.php</td>
            </tr>
        </tbody>
    </table>
</div>

<h5 class="mb-2">Parameter</h5>
<div class="container">
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>No</td>
                <td>String</td>
                <td>Android Application Identity</td>
            </tr>
            <tr>
                <td>GET/HEAD</td>
                <td>ios-key</td>
                <td>No</td>
                <td>String</td>
                <td>IOS Application Identity</td>
            </tr>
            <tr>
                <td>GET</td>
                <td>id</td>
    ...
    <!------tabel request end--------->
      ...
      <nav id="sidebar">
	        ...
	        <ul class="list-unstyled components mb-5">
	          <li>
	            <a href="#" data-toggle="collapse" aria-expanded="false" class="display-7">Start</a>
	          <li>
	            <a href="#" data-toggle="collapse" aria-expanded="false" class="display-7 active-link text-danger">Documention API Key</a>
	          </li>
	          <li>
	            <a href="#" data-toggle="collapse" aria-expanded="false" class="display-7">The rules of API usage</a>
	          </li>
	          <li>
	            <a href="#" data-toggle="collapse" aria-expanded="false" class="display-7">Summary</a>
	          </li>
	        </ul>
